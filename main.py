...
I am currently a PhD student at University College Dublin in Ireland, specializing in solar power forecasting and estimation using artificial intelligence techniques. I work at the <a href= 'https://soumyabrata.dev/theia/'>THEIA lab</a> at UCD. My research focuses on efficient and improved solar forecasting using computer vision and efficient ml. I
have been working on leveraging infrared imaging and model compression techniques to achieve better performance and real-time photovoltaic forecasting capabilities.
<br>
...
<b> Conference: </b> 2023 IEEE 7th Conference on Energy Internet and Energy System Integration (EI2)
15-18 Dec. 2023 <be>
<a href="https://github.com/ifran-rahman/solar-irradiance-estimation-dl">Repo</a> <br>
</div>
''')
txt6(
'''
